...
class Web2All_GoogleSafeBrowsing_SQLStorage_Hashes4b extends Web2All_Table_SaveObject implements Web2All_Table_IListableObject {
  ...
  public function __construct(Web2All_Manager_Main $web2all,$db) {
    ...
    $this->tablename=Web2All_GoogleSafeBrowsing_SQLStorage_Engine::$db_schema['hashes_4b']['table_name'];

    $this->obj_to_db_trans=array(
      'prefix' => Web2All_GoogleSafeBrowsing_SQLStorage_Engine::$db_schema['hashes_4b']['prefix'],
      'lst_id' => Web2All_GoogleSafeBrowsing_SQLStorage_Engine::$db_schema['hashes_4b']['lst_id'],
      'long_prefix' => Web2All_GoogleSafeBrowsing_SQLStorage_Engine::$db_schema['hashes_4b']['long_prefix'],

    );

    $this->key_properties=array($this->obj_to_db_trans['prefix'],$this->obj_to_db_trans['lst_id'],$this->obj_to_db_trans['long_prefix']);
  ...
  {
    return $this->loadFromTable(array($this->obj_to_db_trans['prefix'] => $prefix, $this->obj_to_db_trans['lst_id'] => $lst_id, $this->obj_to_db_trans['long_prefix'] => $long_prefix));
  }
