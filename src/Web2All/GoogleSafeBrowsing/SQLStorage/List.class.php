...
class Web2All_GoogleSafeBrowsing_SQLStorage_List extends Web2All_Table_SaveObject implements Web2All_Table_IListableObject {
  ...
  public function __construct(Web2All_Manager_Main $web2all,$db) {
    ...
    $this->tablename=Web2All_GoogleSafeBrowsing_SQLStorage_Engine::$db_schema['list']['table_name'];

    $this->obj_to_db_trans=array(
      'id' => Web2All_GoogleSafeBrowsing_SQLStorage_Engine::$db_schema['list']['id'],
      'name' => Web2All_GoogleSafeBrowsing_SQLStorage_Engine::$db_schema['list']['name'],
      'description' => Web2All_GoogleSafeBrowsing_SQLStorage_Engine::$db_schema['list']['description'],
      'state' => Web2All_GoogleSafeBrowsing_SQLStorage_Engine::$db_schema['list']['state'],
      'last_updated' => Web2All_GoogleSafeBrowsing_SQLStorage_Engine::$db_schema['list']['last_updated'],
      'last_reset' => Web2All_GoogleSafeBrowsing_SQLStorage_Engine::$db_schema['list']['last_reset'],

    );

    $this->key_properties=array($this->obj_to_db_trans['id']);
  ...
  {
    return $this->loadFromTable(array($this->obj_to_db_trans['id'] => $id));
  }
